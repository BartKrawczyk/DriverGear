...
-- USERS
DELETE FROM users;
INSERT IGNORE INTO users (id, username, password, role, first_name, last_name, locked) VALUES
  (1, 'testuser', '$2a$10$NLlrZizOVhKa3d.wuh2z5uhr6hLmzXw7noZwmIxhl7deKZxLg2Fcm', 'USER', 'Test', 'User', false),
  (2, 'admin', '$2a$10$NLlrZizOVhKa3d.wuh2z5uhr6hLmzXw7noZwmIxhl7deKZxLg2Fcm', 'ADMIN', 'Admin', 'Admin', false);
...
DELETE FROM position_clothing_allowances;
...
DELETE FROM position_clothing_items;
...
-- CLOTHING ALLOWANCES
DELETE FROM clothing_allowances;
...
DELETE FROM clothing_assignments;
INSERT INTO clothing_assignments
(id, employee_id, position_clothing_allowance_id, assignment_date, expiry_date, issued_date, status, notes, created_at) VALUES
                                                                                                                            (1, 1, 1, '2023-01-10', '2024-01-10', '2023-01-15', 'ISSUED', 'Standard issue', NOW()),
                                                                                                                            (2, 2, 2, '2023-01-17', '2024-01-17', '2023-01-20', 'ISSUED', 'Standard issue', NOW()),
                                                                                                                            (3, 3, 3, '2023-01-28', '2024-01-28', '2023-02-01', 'ISSUED', 'Standard issue', NOW()),
                                                                                                                            (4, 4, 4, '2023-02-05', '2024-02-05', '2023-02-10', 'ISSUED', 'Standard issue', NOW());

-- CLOTHING COMPENSATIONS
DELETE FROM clothing_compensations;
